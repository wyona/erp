...
CLASSPATH=$CLASSPATH:lib/jackrabbit-api-1.0-dev-LCR209797.jar
CLASSPATH=$CLASSPATH:lib/jackrabbit-commons-1.0-dev-LCR209797.jar
CLASSPATH=$CLASSPATH:lib/jackrabbit-core-1.0-dev-LCR209797.jar
